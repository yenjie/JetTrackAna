...
class JetData
{
   ...
   float jetPhi[10000];  
   int   jetFlavor[10000];
   float jetTrkMult1[1000];
   float jetTrkMult2[1000];
   float jetTrkMult3[1000];
   float jetTrkMult4[1000];
   float jetTrkMult5[1000];
   float jetTrkMult6[1000];
   float jetTrkMult7[1000];
   float jetTrkMult8[1000];
   float jetTrkW1[1000];
   float jetTrkW2[1000];
   float jetTrkW3[1000];
   float jetTrkW4[1000];
   ...
   float jetTrkW7[1000];
   float jetTrkW8[1000];
   float jetTrkSum1[1000];
   float jetTrkSum2[1000];
   float jetTrkSum3[1000];
   float jetTrkSum4[1000];
   float jetTrkSum5[1000];
   float jetTrkSum6[1000];
   float jetTrkSum7[1000];
   float jetTrkSum8[1000];
   float refPt[10000];  
   
   float genJetPt[10000];  
   float genJetEta[10000];  
   float genJetPhi[10000];  
   ...
   JetData(TTree *t, bool setBranch=1) {
      ...
      t->Branch("jetFlavor",jetFlavor,"jetFlavor[nJet]/I");
      t->Branch("refPt",refPt,"refPt[nJet]/F");
      t->Branch("nGenJet",nGenJet,"nGenJet/I");
      t->Branch("genJetPt",genJetPt,"genJetPt[nGenJet]/F");
      t->Branch("genJetPhi",genJetPhi,"genJetPhi[nGenJet]/F");
      t->Branch("genJetEta",genJetEta,"genJetEta[nGenJet]/F");
      t->Branch("jetTrkMult1",jetTrkMult1,"jetTrkMult1[nJet]/F");
      t->Branch("jetTrkMult2",jetTrkMult2,"jetTrkMult2[nJet]/F");
      t->Branch("jetTrkMult3",jetTrkMult3,"jetTrkMult3[nJet]/F");
      t->Branch("jetTrkMult4",jetTrkMult4,"jetTrkMult4[nJet]/F");
      t->Branch("jetTrkMult5",jetTrkMult5,"jetTrkMult5[nJet]/F");
      t->Branch("jetTrkMult6",jetTrkMult6,"jetTrkMult5[nJet]/F");
      t->Branch("jetTrkMult7",jetTrkMult7,"jetTrkMult5[nJet]/F");
      t->Branch("jetTrkMult8",jetTrkMult8,"jetTrkMult5[nJet]/F");
      t->Branch("jetTrkW1",jetTrkW1,"jetTrkW1[nJet]/F");
      t->Branch("jetTrkW2",jetTrkW2,"jetTrkW2[nJet]/F");
      t->Branch("jetTrkW3",jetTrkW3,"jetTrkW3[nJet]/F");
      t->Branch("jetTrkW4",jetTrkW4,"jetTrkW4[nJet]/F");
      t->Branch("jetTrkW5",jetTrkW5,"jetTrkW5[nJet]/F");
      t->Branch("jetTrkW6",jetTrkW6,"jetTrkW5[nJet]/F");
      t->Branch("jetTrkW7",jetTrkW7,"jetTrkW5[nJet]/F");
      t->Branch("jetTrkW8",jetTrkW8,"jetTrkW5[nJet]/F");
      t->Branch("jetTrkSum1",jetTrkSum1,"jetTrkSum1[nJet]/F");
      t->Branch("jetTrkSum2",jetTrkSum2,"jetTrkSum2[nJet]/F");
      t->Branch("jetTrkSum3",jetTrkSum3,"jetTrkSum3[nJet]/F");
      t->Branch("jetTrkSum4",jetTrkSum4,"jetTrkSum4[nJet]/F");
      t->Branch("jetTrkSum5",jetTrkSum5,"jetTrkSum5[nJet]/F");
      t->Branch("jetTrkSum6",jetTrkSum6,"jetTrkSum5[nJet]/F");
      t->Branch("jetTrkSum7",jetTrkSum7,"jetTrkSum5[nJet]/F");
      t->Branch("jetTrkSum8",jetTrkSum8,"jetTrkSum5[nJet]/F");
      t->Branch("JetIt",&JetIt,"JetIt/I");
      t->Branch("subJetIt",&subJetIt,"subJetIt/I");
      ...
      t->Branch("trkWt",trkWt,"trkWt[nTrk]/F");
      t->Branch("nP",&nP,"nP/I");
      t->Branch("pPt",pPt,"pPt[nP]/F");
      t->Branch("pPhi",pPhi,"pPhi[nP]/F");
      t->Branch("pEta",pEta,"pEta[nP]/F");

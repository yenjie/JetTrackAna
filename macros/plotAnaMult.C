...
void plotAnaMult(char *infname="ana.root")
{    
...
//   c->Divide(4,1);
   ...
   for (int i=0;i<4;i++) {
      ...
      TProfile *pPPMC = new TProfile(Form("pPPMC%d",i),"",nAjBin,AjBins);
      ...
      tPPMC->Draw(Form("-multDiff:Aj>>pPPMC%d",i),recoCut);
...
*/
   ...
   c1->SaveAs("results/MultiplicityDifference-AJ.C");
   c1->SaveAs("results/MultiplicityDifference-AJ.gif");
   c1->SaveAs("results/MultiplicityDifference-AJ.eps");
   c1->SaveAs("results/MultiplicityDifference-AJ.pdf");
